...
import (
	...
	"github.com/LorenzoFerro15/bpfima/internal/controller"
...
func init() {
	...
	utilruntime.Must(bpfimapolitoitv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "232b6493.bpfima.polito.it",
